...
if ($cities && $cities->num_rows > 0) {
    while($row = $cities->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            <td>
                <a href='edit_city.php?id={$row['id']}' class='btn btn-edit'><i class='fa-solid fa-pen'></i> Edit</a>
                <a href='delete_city.php?id={$row['id']}' class='btn btn-delete' onclick=\"return confirm('Are you sure?')\"><i class='fa-solid fa-trash'></i> Delete</a>
            </td>
        </tr>";
    }
} else {
